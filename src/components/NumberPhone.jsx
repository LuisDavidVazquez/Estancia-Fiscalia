...
function NumberPhone() {
  ...
  return (
    <div className="telefono-exterior">
      ...
      <audio ref={beepRef} src="assets/audio/bib.mp3" style={{ display: "none" }}></audio>
        ...
        <div className="telefono-contenido">
          ...
          <div className="telefono-teclado">
            {[1, 2, 3, 4, 5, 6, 7, 8, 9, "-", 0, "borrar"].map((key) => (
              ...
              >
                {key === "borrar" ? (
                  <img src="assets/img/borrar.png" alt="Borrar" className="icono-borrar" />
                ) : (
                  key
                )}
              </button>
          ...
          <button className="boton-llamar" onClick={handleCall}>
            <img src="assets/img/llamada.png" style={{height: "80%"}} alt="Llamar" />
          </button>
        </div>
      </div>
    </div>
