...
function Conepts() {
  ...
  return (
      ...
      <audio ref={audioRef} controls style={{ display: "none" }}>
          <source src="assets/audio/tutorials.mp3" type="audio/mp3" />
        ...
        <section className="section-1">
          <div className="libreta">
            ...
            <div className="libreta-slide">
              ...
              <img src="assets/gif/leer.gif" alt="Concepto" className="libreta-imagen" />

                <h3>{phoneNumbers[currentIndex].title}</h3><br />
                <p>{phoneNumbers[currentIndex].subtitle}</p><br />
              </div>
            </div>
